...
def generate_launch_description():
    ...
    twist_mux_params = os.path.join(get_package_share_directory('mp_bot_robot'),'config','twist_mux.yaml')
    twist_mux = Node(
            package="twist_mux",
    ...
    controller_params_file = os.path.join(get_package_share_directory('mp_bot_robot'),'config','my_controllers.yaml')
